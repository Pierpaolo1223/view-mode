...
Disoccupato. Con un laptop ancora funzionante (per miracolo), un conto corrente che iniziava a fare gli occhiacci e la consapevolezza che il mercato del lavoro IT italiano è un algoritmo scritto male da qualcuno che non ha mai visto una riga di codice in vita sua.

Inizia così la fase più surreale del viaggio: il Grande Ciclo dei Colloqui. Un **while(true)** che sembra progettato apposta per testare non le tue competenze tecniche, ma la tua resistenza psicologica alla fuffa. Un loop infinito dove ogni iterazione è uguale alla precedente, con leggere variazioni sul tema del disagio: recruiter che ghostano, proposte di apprendistato dopo anni di esperienza, o colloqui su tecnologie mai citate nell'annuncio.

I veri protagonisti di questo circo sono i **recruiter**. Non tutti sono uguali: esistono 5 tipi di aziende e 3 tipi di recruiter, e ognuno ha il suo stile per mantenerti in modalità sola lettura.

---

## I 3 tipi di recruiter: Il bestiario di Anastasio

### 🍷 Tipo 1: Il Sommelier della Fuffa
*Quello che ha imparato giusto quel poco per fregare i tecnici*.

Il Sommelier della Fuffa ha studiato non le architetture o i pattern, ma **voi**. Conosce il malessere degli ingegneri — la paura di restare intrappolati in una body rental a vita — e su questa ansia ha costruito una carriera. Usa parole come "refactoring", "debito tecnico" o "clean code" in modo leggermente stonato, come chi parla una lingua che non padroneggia del tutto.

Ti fa sentire intelligente o ignorante a seconda di cosa deve fatturare: ti lusinga per tenerti caldo o ti sminuisce con un "ma" tecnico (che in realtà è economico) per abbassare le tue pretese.

> **Tip #38 – Il test del Sommelier**
> Il test è semplice. Fai una domanda di un certo spessore, non da checklist.
> *Opzione 1 (Strategica):* «Come mai un’azienda piccola vuole adottare i microservizi?» o «Cos’ha intenzione di fare l’azienda con i soldi degli investitori?».
> *Opzione 2 (Operativa):* «Mi descriva un progetto in cui ha dovuto gestire un conflitto tra esigenze di business e debito tecnico. Come l’ha risolto?».
> **Osserva la reazione:** chi ha solo studiato il copione si tradirà con vaghezze o cambi di argomento.

---

### 📉 Tipo 2: Il recruiter scarso
*Quello che non ha letto il tuo CV*.

Non è cattivo, è solo il sintomo di un'azienda che considera il recruiting un costo da minimizzare e non una funzione strategica. È male addestrato e deve riempire posizioni in fretta.
...
### 🦄 Tipo 3: L'entità mitologica
*Quello che sa fare il suo mestiere*.
...
## La doppia tassonomia: Aziende e Modelli
...
## Intermezzo Contabile: OpEx vs CapEx
*Perché ti trattano come ti trattano, spiegato dal CFO*.

*   **OpEx (Operational Expenditure):** Sei la bolletta della luce. Un costo operativo da minimizzare per massimizzare il margine trimestrale.
*   **CapEx (Capital Expenditure):** Sei un asset che crea valore futuro. Il tuo stipendio è R&D, un investimento ammortizzabile nel tempo.
...
## I 5 tipi di colleghi: Il bestiario parte seconda

Riconoscere chi hai intorno è fondamentale per capire se il tuo "kernel" resterà integro.

### 1. 🐍 Il bastone tra le ruote
È colui che ha capito che in azienda non si cresce per merito, ma eliminando gli altri o impedendo loro di crescere. Usa la competenza come arma per proteggere il territorio perché teme chi brilla troppo.
...
## L’epopea dei colloqui (Lezioni dai fallimenti)
